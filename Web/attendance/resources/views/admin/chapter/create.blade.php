...
@section('content')
    <div class=" content-wrapper">
        <div class="content-header">
            ...
            <div class="container-fluid">
                <div class="col-md-6">
                    <form action="{{ route('chapter.store',['id'=>$Comics->id]) }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="">Tên chương</label>
                            <input type="text" class="form-control @error('chapter_name') is-invalid @enderror" name="chapter_name">
                            @error('chapter_name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('chapter_date') is-invalid @enderror" name="chapter_date">
                            @error('chapter_date')
                            <div class="alert alert-danger alert-style">{{ $message }}</div>
                        @enderror
                        </div>
