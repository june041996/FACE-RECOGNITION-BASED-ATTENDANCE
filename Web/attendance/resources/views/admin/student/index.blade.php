                    ...
                    <table class="table table-bordered " id="myTable">
                        ...
                        <tbody>
                            ...
                            <tr> 
                                    ...
                                    <td>
                                        <a href="{{ route('student.edit',['id'=>$itemComment->id]) }}" class="btn btn-warning">Sửa</a>
                                        <a href="{{ route('student.delete',['id'=>$itemComment->id]) }}" 
                                           data-url="{{ route('student.delete',['id'=>$itemComment->id]) }}" class="btn btn-danger action_delete">Xóa</a>
