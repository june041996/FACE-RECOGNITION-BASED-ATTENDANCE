...
<form class="" action="{{ route('follow.store') }}" method="POST" >
    @csrf
    <div class="content">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mt-3">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('follow_date') is-invalid @enderror" type="date" name="follow_date" id="follow_date" value="{{old('follow_date')}}">
                            @error('follow_date')
                        ...
                        <div >
                            ...
                            <select name="comics_name" id="comics_name" class="form-control  @error('comics_name') is-invalid @enderror" >
                                <option value="{{old('comics_name')}}" >{{old('comics_name')}}</option>
                        ...
                        <div >
                            ...
                            <select name="user_name" id="user_name" class="form-control  @error('user_name') is-invalid @enderror" >
                                <option value="{{old('user_name')}}" >{{old('user_name')}}</option>
