...
public class allSubjectAdapter extends RecyclerView.Adapter<allSubjectAdapter.ViewHolder> {
    ...
    public allSubjectAdapter(List<Subject> subjectList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.item_all_subject,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tv_DoW.setText(subject.getDoW());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        public TextView tvNameSubject,tvNameTeacher,tvDate,tvTime,tv_DoW;
        ...
        public ViewHolder(View convertView) {
            ...
            tv_DoW = convertView.findViewById(R.id.tv_DoW);
